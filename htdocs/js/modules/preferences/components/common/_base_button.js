    ...
    return React.createClass({
        ...
        render: function () {
            ...
            return _.div({ className: 'button-container-component' },
                ...
                activeNode[0].options.buttons.indexOf('remove') !== -1 ? _.button({ className: 'button-element remove-button', onClick: this.setActiveNodeTreeStatus.bind(null, 'remove') }, '-') : null,
