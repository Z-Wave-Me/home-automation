            ...
            require([collectionObject.path], function (collection) {
                ...
                if (collectionObject.name === 'Devices') {
                    that.registerHandler(collectionObject.name , 'add', function () {
                        var devices = that.collections[collectionObject.name].collection.toJSON();
                        state.set('devices', devices);
                        state.set('devicesCount', devices.length);
                        state.set('devicesUpdateTime', devices.updateTime || 0);
                    });
                }
