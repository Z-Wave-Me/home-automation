 ...
 * The object will be saved only periodiclly and will be stripped to a limit and filtered using filter function.
...
LimitedArray.prototype.save = function() {
	if (this.counter-- === 0) {
		...
		// limit the object size
		if (this.limit) {
			this.object = this.object.slice(0, this.limit);
		}
